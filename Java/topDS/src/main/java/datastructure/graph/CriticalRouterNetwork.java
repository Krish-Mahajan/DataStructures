 ...
 *
 */
public class CriticalRouterNetwork {
		...
		//DFS Util Method
		private void connectedComponentsDFSUtil(Map<Integer,Boolean> visited,Stack<Integer> stack,int nodeIndex) {
	...
	public static void main(String[] args) {
		...
		CriticalRouterNetwork g = new CriticalRouterNetwork(6);
        g.addEdge(1, 2, 0);
        g.addEdge(2, 1, 0);
